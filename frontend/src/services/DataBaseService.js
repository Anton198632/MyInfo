...
const useDataBaseService = () => {
    ...
    const setTheme = async (username, theme) => {
        ...
        return await request("", `${address}/set_theme?session_id=${keyPair.sessionId}&data=${encrypt_data}`);
    }

    const getSettings = async (username) => {

        const encrypt_data = encodeURIComponent(encrypt(keyPair.serverPublicKeyPem, {username, hash}));
        return await request("", `${address}/get_settings?session_id=${keyPair.sessionId}&data=${encrypt_data}`);
    }
    ...
    const getAuthorizationData = async () => {
        ...
        return await request("", `${address}/get_authorization_data?session_id=${keyPair.sessionId}`, 
                "POST", JSON.stringify({data: encrypt_data}));
    }
    ...
    const registration = async (login, password, passwordRep) => {
        ...
        return await request("", `${address}/registration?session_id=${keyPair.sessionId}`,
                "POST", JSON.stringify({data: encrypt_data}));
    }
    ...
    const logIn = async (login, password) => {
        ...
        return await request("", `${address}/login?session_id=${keyPair.sessionId}`,
                "POST", JSON.stringify({data: encrypt_data}));
    }

    const logOut = async () => {
        return await request("", `${address}/logout?session_id=${keyPair.sessionId}`);
    }
    ...
    const changeUserAvatar = async (userId, file) => {
        ...
        return await request("", 
            `${address}/change_user_avatar?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    ...
    const getSections = async (userName) => {
        ...
        return await request("", 
            `${address}/get_sections?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const uploadSectionImage = async (sectionId, file) => {
        ...
        return await request("", 
            `${address}/upload_section_image?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    }
    ...
    const addNewSection = async (userName, title) => {
        ...
        return await request("", 
            `${address}/add_new_section?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    } 
    ...
    const deleteSection = async (sectionId) => {
        ...
        return await request("", 
            `${address}/delete_section?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const getItems = async (sectionId) => {
        ...
        const encrypt_data = encodeURIComponent(encrypt(keyPair.serverPublicKeyPem, {sectionId})[0])
        return await request("", 
            `${address}/get_items?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const getItemsByWords = async(sectionId, words) => {
        ...
        return await request("", 
        `${address}/get_items_by_words?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const uploadItemImage = async (itemId, file) => {
        ...
        return await request("", 
        `${address}/upload_item_image?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    }
    ...
    const addNewItem = async (sectionId, itemId, title) => {
        ...
        return await request("", 
            `${address}/add_new_item?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const updateItem = async (itemId, title, tags) => {
        ...
        return await request("", 
            `${address}/update_item?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const deleteItem = async (itemId) => {
        ...
        return await request("", 
            `${address}/delete_item?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const setItemIcon = async (itemId, attach_id) => {
        ...
        return await request("", 
            `${address}/set_item_icon?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const uploadUserIcon = async (username, file) => {
        ...
        return await request("", 
        `${address}/upload_icon?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    }
    ...
    const getIcons = async (username) => {
        ...
        const encrypt_data = encodeURIComponent(encrypt(keyPair.serverPublicKeyPem, {username})[0])
        return await request("", 
        `${address}/get_icons?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const setIconName = async (iconId, name) => {
        ...
        return await request("", 
        `${address}/set_icon_name?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const deleteIcon = async (iconId) => {
        ...
        return await request("", 
        `${address}/delete_icon?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const getData = async (itemId) => {
        ...
        const encrypt_data = encodeURIComponent(encrypt(keyPair.serverPublicKeyPem, {itemId})[0])
        return await request("", 
        `${address}/get_data?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
    ...
    const uploadDataImage = async (file) => {
        ...
        return await request("", 
        `${address}/upload_data_image?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    }
    ...
    const uploadFile = async (fileName, file) => {
        ...
        return await request("", 
        `${address}/upload_file?session_id=${keyPair.sessionId}&data=${encrypt_data}`, 
            "POST", file, {})
    }
    ...
    const saveData = async (itemId, data) => {
        ...
        return await request("", `${address}/save_data?session_id=${keyPair.sessionId}`,
                "POST", JSON.stringify({data: encrypt_data}));
    }
    ...
    const deleteData = async (dataId) => {
        ...
        return await request("", 
        `${address}/delete_data?session_id=${keyPair.sessionId}&data=${encrypt_data}`)
    }
